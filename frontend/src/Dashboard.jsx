...
function Dashboard({ username, onLogout }) {
  ...
  return (
    <div style={card}>
      ...
      <h2 style={{ color: '#06d6a0', fontSize: '1.2rem', marginBottom: '8px' }}>
        Access Granted
      </h2>
      <p style={{ color: '#e2e8f0', fontSize: '1rem', marginBottom: '4px' }}>
        Welcome, <strong>{username}</strong>
      </p>
      <p style={{ color: '#7b8db0', fontSize: '0.82rem', marginBottom: '24px' }}>
      ...
      >
        <p style={{ color: '#7b8db0', fontSize: '0.72rem', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '8px' }}>
          Session Info
        </p>
